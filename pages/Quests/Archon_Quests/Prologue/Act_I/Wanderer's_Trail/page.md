# Wanderer's Trail
Wanderer's Trail is an {[Archon Quest]page::Quests/Archon_Quests/folder.md}. It acts as the introductory quest for Genshin Impact's main story line, the Archon Quests. It also serves to familiarize the player with basic character movements and actions.
...
## Notes
- The Hydro Slime will never respawn if defeated (optional).
